...
Source0  : https://files.pythonhosted.org/packages/23/14/cfda3fe61ce4c0f50a9f707ae02b46cb53211732b2cd4522bf06272848f4/mido-1.3.3.tar.gz
...
%prep
%setup -q -n mido-1.3.3
cd %{_builddir}/mido-1.3.3
pushd ..
cp -a mido-1.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730145018
